        ...
        <div>
          <div className="flex items-center gap-3 mb-4 max-md:mt-10">
            ...
            <div>
              ...
              <p>Used by 1M+ Users Around the Globe</p>
            </div>
          </div>
          <h1 className="text-3xl md:text-6xl md:pb-2 font-bold bg-gradient-to-r from-violet-500 to-fuchsia-500 bg-clip-text text-transparent">
